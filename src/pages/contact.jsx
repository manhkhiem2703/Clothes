          ...
          <div className="row text-center align-items-center">
            <div className="col-lg-6 col-md-12 p-3">
              <div className="map card m-auto embed-responsive embed-responsive-16by9">
                ...
                ></iframe> */}
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.0487922627053!2d106.70014101138318!3d10.807575058572375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528bf02414443%3A0x188f12841b11c755!2zMjE3IELDuWkgxJDDrG5oIFR1w70sIFBoxrDhu51uZyAyNCwgQsOsbmggVGjhuqFuaCwgVGjDoG5oIHBo4buRIEjhu5MgQ2jDrSBNaW5oIDg0ODAwLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1695630158023!5m2!1svi!2s"
                  allowfullscreen=""
                  loading="lazy"
                  referrerpolicy="no-referrer-when-downgrade"
                ></iframe>
            ...
            <div className="col-lg-6 col-md-12">
              <div className="card p-5">
                ...
                <p className="mb-2">
                  <b>Address:</b> 217/70 Bui Dinh Tuy Street, Ward 24, Binh Thanh District, HCMC
                </p>
                <p className="mb-2">
                  <b>Phone:</b>{" "}
                  <a className="footer-tel" href="tel:+1234567890">
                    Call us at +84 (939) 612-721
                  </a>
                </p>
                <p className="mb-4">
