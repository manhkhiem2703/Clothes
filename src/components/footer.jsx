    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  217/70 Bui Dinh Tuy Street, Ward 24, Binh Thanh District, HCMC</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+84939612721">Call us at +84 (939) 612-721</a></p> </div>
